...
#include "../../01-22-VideoPlayer/GroupBox.h"
...
QT_MOC_LITERAL(1, 9, 15), // "signalMovePoint"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 13) // "doubleClicked"

    },
    "GroupBox\0signalMovePoint\0\0doubleClicked"
};
...
void GroupBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GroupBox::*_t)(QPoint );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupBox::signalMovePoint)) {
                *result = 0;
            }
        }
        {
            typedef void (GroupBox::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupBox::doubleClicked)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject GroupBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GroupBox.data,
      qt_meta_data_GroupBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void GroupBox::signalMovePoint(QPoint _t1)
{
